...
import com.uname.your_application.entrance.LandingScreenActivity;
import com.uname.your_application.entrance.LogInActivity;
import com.uname.your_application.entrance.SignUpActivity;
...
public class AuthHelper {
    ...
    static String getCurrentUserGUID() {
        try {
    ...
    public void createUserEmail(String email, String password, String gender, Calendar dob, @Nullable final SignUpActivity signUpActivity) {
